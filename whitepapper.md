---
title: "Toward a Programmable Inflation Hedge: The $FLATCOIN Model"
---
...
- Flatcoin Positions: Purchased at the base price (1 USDT), redeemable with interest to preserve purchasing power.
- Future Positions: Created by users who sell a position with a premium price (e.g., $1.02), reflecting inflation expectations. Buyers of these positions are betting that future inflation will exceed the premium.
...
- Preserve purchasing power for users holding $FLAT over time.
- Signal inflationary expectations through system activity and pricing behavior.
...
| Order Type | Mint/Burn Impact | Inflation Signal | Liquidity Role |
|-----------|-----------------|------------------|----------------|
| Spot Buy | Mints $FLAT | Yes | Adds upward demand pressure |
| Spot Sell | Burns $FLAT | Yes | Provides exit liquidity |
| Buy Order | No impact | Indirect | Enables entry at custom price |
| Sell Order | No impact | Indirect | Enables secondary market pricing |
